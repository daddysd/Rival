...
public class SpearPillagerEntity extends Monster implements GeoEntity {
	...
	public SpearPillagerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RivalModEntities.SPEAR_PILLAGER.get(), world);
	}

	public SpearPillagerEntity(EntityType<SpearPillagerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
