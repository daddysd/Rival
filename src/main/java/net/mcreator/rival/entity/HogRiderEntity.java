...
public class HogRiderEntity extends Monster implements GeoEntity {
	...
	public HogRiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RivalModEntities.HOG_RIDER.get(), world);
	}

	public HogRiderEntity(EntityType<HogRiderEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "pillagertest2");
	}
